...
export function buildEnv(db: D1Database, assets: Fetcher, secrets: Record<string, string>): Env {
  ...
  return {
    ...
    SESSION_TIMEOUT_MINUTES: e.SESSION_TIMEOUT_MINUTES,
    ...
    UPGRADE_DEPLOYMENT_TARGET: e.UPGRADE_DEPLOYMENT_TARGET,
    UPGRADE_RELEASE_TARGET: e.UPGRADE_RELEASE_TARGET,
    UPGRADE_RELEASE_CHANNEL: e.UPGRADE_RELEASE_CHANNEL,
    UPGRADE_RELEASE_MANIFEST_URL: e.UPGRADE_RELEASE_MANIFEST_URL,
    UPGRADE_SCHEMA_VERSION: e.UPGRADE_SCHEMA_VERSION,
    UPGRADE_CURRENT_IMAGE_DIGEST: e.UPGRADE_CURRENT_IMAGE_DIGEST,
    UPGRADE_CONTROLLER_TYPE: e.UPGRADE_CONTROLLER_TYPE,
    UPGRADE_CONTROLLER_VERSION: e.UPGRADE_CONTROLLER_VERSION,
    AZURE_DEVOPS_ORGANIZATION: e.AZURE_DEVOPS_ORGANIZATION,
    AZURE_DEVOPS_PROJECT: e.AZURE_DEVOPS_PROJECT,
    AZURE_DEVOPS_PIPELINE_ID: e.AZURE_DEVOPS_PIPELINE_ID,
    AZURE_DEVOPS_PIPELINE_REF: e.AZURE_DEVOPS_PIPELINE_REF,
    AZURE_DEVOPS_PIPELINE_NAME: e.AZURE_DEVOPS_PIPELINE_NAME,
    AZURE_CLIENT_ID: e.AZURE_CLIENT_ID,
    IDENTITY_ENDPOINT: e.IDENTITY_ENDPOINT,
